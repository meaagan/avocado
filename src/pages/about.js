    ...
    render={data => (
      <Layout>
        ...
        <Container>
          ...
          <p>Sylvie, la chef, s’appropria rapidement sa nouvelle cuisine, et l’équipe expérimentée du Willow contribua à faire du bistro un succès instantané. Il aurait été impossible d’imposer un succès si rapide - et surtout, de le maintenir - sans la complicité des employés qui ont été extraordinairement dédiés à offrir un service à la clientèle courtois et chaleureux, et sans une cuisine d’une fraîcheur et d’une qualité irréprochables. Les sushis de Sylvie relèvent tout simplement de la magie culinaire, mais l’enchantement provient aussi des baguettes du savoir- faire et du service à la clientèle, manipulées par les doigts de fée de Chantal, Danielle, Cathy, Tess et Charlie. Nous sommes fiers d’appartenir à cette équipe gagnante!</p>
          </Container>
      </Layout>
    )}
  />
